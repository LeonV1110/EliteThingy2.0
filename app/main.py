...
def get_possible_biologicals(body: Body, biological_list: list[Biological]):
...
def get_most_likely_biologicals(body: Body, biological_list: list[Biological]):
...
def get_most_valuable_biologicals(body: Body, biological_list: list[Biological]):
...
def get_least_valuable_biologicals(body: Body, biological_list: list[Biological]):
    
    possible_biologicals = get_possible_biologicals(body, biological_list)

    #sort on value and reverse for low value
